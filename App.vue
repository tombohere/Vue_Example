<template>
  <div id="app" class="content">
    <div id="preloaded-images">
      <img
        src="http://lorempixel.com/500/800/?random&1"
        width="1"
        height="1"
        alt=""
      />
      <img
        src="http://lorempixel.com/500/800/?random&2"
        width="1"
        height="1"
        alt=""
      />
      <img
        src="http://lorempixel.com/500/800/?random&3"
        width="1"
        height="1"
        alt=""
      />
    ...
    <div class="nav">
      ...
      <ul>
        <router-link
          to="/"
          tag="li"
          v-bind:class="$route.path == '/' ? 'is-chosen' : 'is-not'"
            ...
            <router-link to="/list/list1" tag="li"
              ...
              <ul>
                <router-link to="/list/list1/rev1" tag="li"
                  ><a>Rev 1</a></router-link
                >
                <router-link to="/list/list1/rev2" tag="li"
                  ><a>Rev 2</a></router-link
                >
              </ul>
            </router-link>
            <router-link to="/list/list2" tag="li"
              ...
              <ul>
                <router-link to="/list/list2/rev3" tag="li"
                  ><a>Rev 3</a></router-link
                >
                <router-link to="/list/list2/rev4" tag="li"
                  ><a>Rev 4</a></router-link
                >
              </ul>
            </router-link>
          </ul>
